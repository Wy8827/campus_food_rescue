            ...
            <div class="content-container">
                ...
                <ul class="moderation-list">
                    <li class="moderation-list-item">
                        <article class="listing-card">
                            <div class="card-header-row">
                                ...
                                <span class="urgent-badge badge-urgent"></ion-icon> Expires in 45m</span>
                            </div>
                    ...
                    <li class="moderation-list-item">
                        <article class="listing-card">
                            <div class="card-header-row">
                                <span class="item-code">#FR-2930</span>
                                <span class="urgent-badge badge-normal">Expires in 24h</span>
                            </div>
